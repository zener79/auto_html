...
class GoogleMapTest < Test::Unit::TestCase
  ...
  def test_transform_2
    filter = GoogleMap.new
    result = filter.call('http://maps.google.com/maps?hl=en&q=newyork&gs_sm=e&gs_upl=917l917l0l1666l1l1l0l0l0l0l317l317l3-1l1l0&bav=on.2,or.r_gc.r_pw.,cf.osb&biw=1280&bih=679&um=1&ie=UTF-8&sa=N&tab=wl')
  ...
  def test_show_info
    filter = GoogleMap.new(show_info: false)
  ...
  def test_type_and_zoom
    filter = GoogleMap.new(type: :satellite, zoom: 3)
    result = filter.call('http://maps.google.com.br/maps?q=Joinville+-+Santa+Catarina')
